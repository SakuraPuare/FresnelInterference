...
// 为了保持与原有代码的兼容性，在全局作用域中使用 using 声明
using MVSDKTypes::CameraHandle;
using MVSDKTypes::INT;
using MVSDKTypes::LONG;
using MVSDKTypes::UINT;
using MVSDKTypes::UINT64;
using MVSDKTypes::BOOL;
using MVSDKTypes::BYTE;
using MVSDKTypes::DWORD;
using MVSDKTypes::PVOID;
using MVSDKTypes::LPCTSTR;
using MVSDKTypes::USHORT;
using MVSDKTypes::SHORT;
using MVSDKTypes::LPBYTE;
using MVSDKTypes::CHAR;
using MVSDKTypes::TCHAR;
using MVSDKTypes::WORD;
using MVSDKTypes::HANDLE;
using MVSDKTypes::VOID;
using MVSDKTypes::ULONG;
using MVSDKTypes::LPVOID;
using MVSDKTypes::UCHAR;
// 注意：HWND 和 HMODULE 不进行 using 声明，避免与系统类型冲突
